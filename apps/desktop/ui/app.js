...
function updateActionLabel() {
  ...
  const local = ["review", "agent", "conflicts", "ask", "fleet-ask", "fleet-plan", "report", "security", "plan-history", "implement", "work-plan", "init", "auth-status", "sessions-list", "sessions-compact", "sessions-checkpoints", "benchmark", "search", "plugins", "lsp", "tasks-list"].includes(action.value);
