...
function updateActionLabel() {
  ...
  targetLabel.textContent = action.value === "ask" || action.value === "chat" || action.value === "fleet-ask" || action.value === "fleet-plan" ? "Repository question or request" : action.value === "bundle-verify" ? "Review bundle JSON" : action.value === "work-plan" ? "PRD, design, or work request" : action.value === "complete" ? "File path" : action.value === "pr-view" ? "GitHub pull request" : local ? "Repository path" : action.value === "plan" ? "Change request or issue" : action.value === "task" ? "GitHub issue" : "GitHub pull request";
