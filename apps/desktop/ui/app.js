...
function updateActionLabel() {
  const labels = { analyze: "Analyze change", consensus: "Run consensus gate", review: "Review local changes", agent: "Sandbox fix and verify", autofix: "Review-thread autofix", plan: "Generate plan", fix: "Suggest safe fix", simplify: "Simplify changed code", tests: "Generate tests" };
  ...
  apply.disabled = !["fix", "simplify"].includes(action.value);
