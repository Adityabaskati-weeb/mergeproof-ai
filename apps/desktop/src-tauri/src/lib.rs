...
fn cli_args(
    ...
    if !matches!(command, "analyze" | "consensus" | "walkthrough" | "erd" | "plan" | "fix" | "simplify" | "tests" | "docstrings" | "review" | "agent" | "task" | "implement" | "recipe" | "autofix" | "conflicts" | "resolve" | "ask" | "report") {
