...
- Publish a GitHub review with an evidence-gated approval boundary: `APPROVE` is withheld unless the current head SHA, attestation, citations, criteria, security gate, and custom checks all pass
