...
export type SlackAutomationAction = "review" | "investigate" | "plan" | "fix" | "simplify" | "tests" | "consensus" | "learn";
...
function validAction(value: unknown): value is SlackAutomationAction {
  return value === "review" || value === "investigate" || value === "plan" || value === "fix" || value === "simplify" || value === "tests" || value === "consensus" || value === "learn";
}
