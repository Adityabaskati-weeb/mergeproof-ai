...
export function formatPullRequestSummary(analysis: Analysis): string {
  ...
  return [
    ...
    `**Model:** \`${analysis.trace.model}\` | **Verified citations:** ${analysis.trace.citedSources}/${analysis.trace.fetchedSources} | **Unsupported claims:** ${analysis.trace.unsupportedClaims}`,
    "",
    "### Criteria",
    rows,
